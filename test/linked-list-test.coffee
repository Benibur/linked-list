...
l = new LinkedList()  # list to run tests on
...
describe "list.remove(rank) - remove all nodes", ->
    before () ->
        l = new LinkedList()
        l.append('c')
        l.prepend('a')
